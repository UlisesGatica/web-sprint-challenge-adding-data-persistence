...
1. Explain the difference between Relational Databases and SQL.
 Sql makes things easier by letting you see the table
2. Why do tables need a Primary Key? it ensures row level accessibility
3. What is the name given to a table column that references the Primary Key on another table? foreign key
4. What do we need in order to have a _many to many_ relationship between two tables? intermediate table or sometimes a linking or junction table